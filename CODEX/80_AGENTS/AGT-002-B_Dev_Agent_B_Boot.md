---
id: AGT-002-B-SPR004
title: "Dev Agent B Boot — JOB-004 Frontend + Tests"
type: how-to
status: ACTIVE
owner: architect
agents: [coder]
...
> **BLUF:** You are Dev Agent B for Sprint 004. You build the login/registration UI, auth context, GitHub settings page, PR link display, and all tests for auth + GitHub flows. 5 tasks. Work on `feature/JOB-004-frontend-tests`.

# Dev Agent B — JOB-004 Boot Document
